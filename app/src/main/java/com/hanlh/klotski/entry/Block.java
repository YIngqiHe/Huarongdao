package com.hanlh.klotski.entry;
...
import com.hanlh.klotski.activity.GameActivity;
import com.hanlh.klotski.view.GameBoard;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (index == 0 && x == 1 && y == 3) {
                    mGameBoard.setSuccess( true);
                    setImageResource(R.drawable.chicken2);
